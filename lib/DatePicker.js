    ...
    (0, _createClass3['default'])(DatePicker, [{
        ...
        value: function getDateData() {
            ...
            for (var i = minDateYear; i <= maxDateYear; i++) {
                var label = formatYear ? formatYear(i, date) : i + locale.year + '';
                years.push({
                    value: i + '',
                    label: label
                });
            ...
            for (var _i = minMonth; _i <= maxMonth; _i++) {
                var _label = formatMonth ? formatMonth(_i, date) : _i + 1 + locale.month + '';
                months.push({
                    value: _i + '',
                    label: _label
                });
            ...
            for (var _i2 = minDay; _i2 <= maxDay; _i2++) {
                var _label2 = formatDay ? formatDay(_i2, date) : _i2 + locale.day + '';
                days.push({
                    value: _i2 + '',
                    label: _label2
                });
